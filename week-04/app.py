...
st.subheader("6. Duration Spread by Content Type")
st.markdown('<p class="chart-desc">What this shows: the usual range of movie runtimes — the typical middle range, plus any unusually long or short titles.</p>', unsafe_allow_html=True)
c1, c2 = st.columns([2, 1])
with c1:
    fig, ax = plt.subplots(figsize=(7, 4))
    sns.boxplot(data=filtered_df, x="type", y="duration_value", ax=ax, color=CLR_SAGE)
...
st.subheader("8. Top Genres (Category Comparison)")
