...
In week-02 i had revised Python fundamentals , practiced Lists, Tuples, Dictionaries . Implemented File Handling and CSV Handling and practiced Exception Handling.And for  the weekly  task I had built Student Performance Summary Program and  Data Analyze program which analyze data and give imp information about data like total numner of rows and columns , column names and missing values. I had also created a mini ytility called Data Health Checker Utility which inspects and analyze data.
